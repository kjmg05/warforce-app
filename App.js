...
import {
  ...
  PagesPlanets,
  PagesStarships,
} from "./src/components/screens/Pages";
    ...
    <SafeAreaView style={styles.container}>
      ...
      <NavigationContainer>
        <Stack.Navigator>
          ...
          />
          <Stack.Screen
            name="SwInfoCharacter"
            component={SwInfoCharacter}
            options={{
